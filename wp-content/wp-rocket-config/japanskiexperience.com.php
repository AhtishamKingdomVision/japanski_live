...
$rocket_cookie_hash = '5dc5b114e6e321408f6f532934af561c';
$rocket_logged_in_cookie = 'wordpress_logged_in_5dc5b114e6e321408f6f532934af561c';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_reject_uri = '/booking/|/wp-login.php/|/wp-admin/(.*)/|/admin-ajax.php/|/wp-json/(.*)/|/wc-api/(.*)/|/feed/(.*)/|/sitemap(.*).xml/|/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/(index.php/)?(.*)wp-json(/.*|$)';
...
$rocket_secret_cache_key = '6a476509c0fe0669538594';
$rocket_cache_ssl = 1;
