...
echo '<section id="'.str_replace(' ', '', $id).'" class="'. $class . ' full-section simple_title_content_with_full_bg_color '. $text .'" style="background-color: '.$bg_color.';padding-top:'.$top.';padding-bottom: '.$bottom.';">';
