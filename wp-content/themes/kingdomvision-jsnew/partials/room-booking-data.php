                ...
                <div class="rb-room-card room-card"
                    ...
                    <div class="rb-rateplans">
                        ...
                        foreach ($allRooms as $rateplanSeq => $room) :
                            ...
                            // RoomBoss property: never render BedBank-only rate rows (Select CTA).
                            if (empty($property_is_bedbank) && $isBedbank) {
                                continue;
                            }
