...
$external_url = $is_stay_user ? 'https://stay.japanskiexperience.com' : 'https://trip.japanskiexperience.com';
// pre( $external_url );
// $authToken = '12498|nxYGHNDbeM400rHiOftxkjGcI0wKVZ41APd22jBJfa490d93';
$authToken = $is_stay_user ? '10530|1AOM2D6filRSzAyD7GWpV9Vy8za5sBNK32r6rE9G45ce4a71' : '12498|nxYGHNDbeM400rHiOftxkjGcI0wKVZ41APd22jBJfa490d93';
...
// add_action('wp_head', 'test_func_trip');
// function test_func_trip(){
//     pre( 'external_url' );
//     pre( KV_BOOKING_SYSTEM_BASE );
// }
