...
$external_url = 'https://trip.japanskiexperience.com'; $authToken = '12766|RwqdJ6LQOZr2Fn6r3B1orp2sxz37ozHuR2XZ9HDp6f206b33'; // trip.japanskiexperience.com
// pre( $external_url );


if (!defined('KV_BOOKING_SYSTEM_BASE')) {
    define('KV_BOOKING_SYSTEM_BASE', $external_url);
}

if (!defined('KV_BS_authToken')) {
...

{
    ...
    try {
        ...
        $args = [
            ...
            // 'post_status'    => ['publish', 'draft', 'pending'], Publish room will will fetched
            'post_status'    => ['publish'],
